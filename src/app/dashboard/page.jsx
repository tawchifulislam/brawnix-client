      ...
      <div className="mx-auto max-w-6xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        <div className="lg:col-span-3 bg-slate-50/60 dark:bg-slate-950/40 border border-slate-200/60 dark:border-slate-800 p-4 rounded-3xl space-y-1 shadow-sm">
          ...
          {[
            ...
            { id: 'apply', label: 'Apply as Trainer' },
          ].map(tab => (
            <button
              key={tab.id}
          ...
          {activeTab === 'apply' && (
            <div className="animate-fadeIn">
              ...
              <p className="text-xs text-slate-400 mb-5">
                Submit your official industrial profile credentials below.
                Brawnix admins will review it for recruitment status updates.
              </p>
              ...
              <form onSubmit={handleTrainerApply} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full mt-2 rounded-xl bg-orange-600 hover:bg-orange-700 dark:bg-orange-500 dark:hover:bg-orange-600 px-4 py-3 text-xs font-black uppercase tracking-wider text-white shadow-md shadow-orange-500/10 transition-all duration-200 cursor-pointer"
                >
                  Submit Profile
                </button>
              </form>
